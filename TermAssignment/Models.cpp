...
namespace Models
{
	...
	// Creates a cylinder primitive.
	//void CreateWierdCylinder(VertexCollection& vertices, IndexCollection& indices, float height, float diameterBot, float diameterTop, size_t tessellation)
	//{
	//	if (tessellation < 3)
	//		throw std::out_of_range("tesselation parameter out of range");
	...
	//	float radiusBot = diameterBot / 2;
	//	float radiusTop = radiusTop / 2;
	//	size_t stride = tessellation + 1;
