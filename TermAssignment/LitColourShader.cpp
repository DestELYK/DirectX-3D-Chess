...
// Sets the directional light
//-----------------------------------------------------
void LitColourShader::SetDirectionalLight3(Color clr, Vector3 direction)
{
	lightsDirty = true;
	lightingValues.directionalLightColor3 = clr;

	// flip the direction of the vector so aligning with the normal is brightest
	lightingValues.directionalLightVector3 = Vector4(-direction.x, -direction.y, -direction.z, 0);
